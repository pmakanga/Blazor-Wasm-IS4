    ...
    public class InMemoryConfig
    {
        public static IEnumerable<IdentityResource> GetIdentityResources() =>
           new List<IdentityResource>
           {
                ...
                new IdentityResources.Address(), // add additional claims
            ...
            new List<Client>
            {
               ...
               new Client
               {
                   ...
                   { 
                       ...
                       IdentityServerConstants.StandardScopes.Address, // add additional scope, display address claims
                       "roles",
                       "companyApi",
                       "position",// scopes for policy based access control
                       "country"
                   },
                   ClientSecrets = { new Secret("MVCSecret".Sha512()) },
                   PostLogoutRedirectUris = new List<string> { "https://localhost:5010/signout-callback-oidc" },
                   RequireConsent = true // show the consent page
               }
            };
    }
}
